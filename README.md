## 안녕하세요, 저는 조민우입니다 👋
**클라우드 & 인프라 엔지니어를 지향합니다 | 우리FISA 클라우드 엔지니어링 과정 수료예정**
...
| AWS SysOps Administrator – Associate | Amazon Web Services | 2026-02 |
...
| 프로젝트 | 설명 | 기간 |
|---------|------|------|
| [증권 온프레미스 인프라 구축](#) | VMware vSphere로 증권 도메인 온프레미스 인프라 설계 및 구축 실습 | 2026.03.05 – 03.13 |
| [HA-Project · DB 이중화](#) | DB 이중화 구성 및 모니터링 시스템 구축. 기술세미나 발표 | 2026.01.20 – 02.05 |
| [이상금융거래 대응 자동화](#) | n8n 기반 워크플로우로 이상 금융거래 탐지 및 대응 자동화 플랫폼 구축 | 2026.01.09 – 01.23 |
...
| 주제 | 내용 | 날짜 |
|------|------|------|
| [Linux 실전 활용](#) | find · grep · awk · jq · yq · shell script를 활용한 시나리오 기반 문제 해결 실습 | 2026.03.19 |
| [우리카드 소비 분석](#) | 우리카드 실 소비 데이터를 ELK 스택으로 분석해 잠재 고객 유치 인사이트 도출 | 2026.01.15 |
